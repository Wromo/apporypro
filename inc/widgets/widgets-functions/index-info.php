...
/**************** Index Info widgets ***************************/
class apporypro_index_text_widget extends WP_Widget {
	function __construct() {
		$widget_ops  = array('classname' => 'apporypro-index-info-widget', 'description' => __('Display  index info widgets for AppOryPro Template', 'apporypro'));
		$control_ops = array('width' => 200, 'height' => 250);
		parent::__construct(false, $name = __('TF: Index Info', 'apporypro'), $widget_ops, $control_ops);
	}
	function form($instance) {
		...
		<p>
			...
			<?php _e( 'Number of page:', 'apporypro' ); ?>
			</label>
