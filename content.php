...
$apporypro_settings = apporypro_get_theme_options(); ?>
	<article id="post-<?php the_ID(); ?>" <?php post_class();?>>
		...
		$entry_format_meta_blog = $apporypro_settings['apporypro_entry_meta_blog'];
			...
			<div class="post-all-content">
				...
				<div class="entry-content">
					...
					if($content_display == 'excerptblog_display'):
							the_excerpt(); ?>
						<?php else:
							the_content( sprintf(esc_html($apporypro_tag_text).'%s', '<span class="screen-reader-text">  '.get_the_title().'</span>' ));
						endif; ?>
