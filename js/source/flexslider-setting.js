jQuery( document ).ready(function($) {
	...
	$('#secondary .product-slider, #secondary .product-slider-four, #secondary .product-slider-six, #colophon .product-slider, #colophon .product-slider-four,  #colophon .product-slider-six,  .apporypro-template-footer-column .product-slider, .apporypro-template-footer-column .product-slider-four, .apporypro-template-footer-column .product-slider-six').flexslider({
		animation: "slide",
		animationLoop: true,
		slideshow: true,
		controlNav: false,
