jQuery( function() {
    ...
    var appOryProLink = jQuery('.header-right .cart-box .sx-cart-views, .header-right .cart-box .widget_shopping_cart .widget_shopping_cart_content .cart_list .mini_cart_item, .header-right .cart-box .widget_shopping_cart .widget_shopping_cart_content p').children('a');

        appOryProLink.on( 'focus', function(){
            jQuery(this).parents('.header-right .cart-box').addClass('focus');
        });
        appOryProLink.on( 'focusout', function(){
    ...
    jQuery('a.popup-info').bind('focus blur', function () {
        jQuery(this).closest('figure').find('.product-item-utility').toggleClass('focus');
    });
